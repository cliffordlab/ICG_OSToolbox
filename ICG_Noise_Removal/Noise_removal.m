...
% OVERVIEW:
%    Main file for "An Open-Source Toolbox for Automated Removal of Noisy
%    Beats for Accurate ICG Analysis"
...
% INPUT:
%    Synchronizd ECG and ICG signal.
...
input_ECG_ICG_Folder = 'D:\Clifford_Lab\Github\ICG_OSToolbox\ICG_ECG_Demo_Data\ECG_ICG_Data\';

% Output folder for saving three stage EA ECG and ICG and Beat contribution factor
EA_folder = 'D:\Clifford_Lab\Github\ICG_OSToolbox\ICG_ECG_Demo_Data\Ensemble_Averaged_ECG_ICG\';   % Destination for Ensemble Averaged data
...
for r = 1: length(Files)        % Selecting two records for Demo
...
%% 7. Synchronizing 60 sec non overlapping ICG signal using R peaks and median RR interval 
 ...
 %% 8. Implementing three - stage noise removal algo
        ...
        % Beat contribution factor for three stage EA beat
